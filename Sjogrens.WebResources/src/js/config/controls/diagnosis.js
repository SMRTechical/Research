export const patientMeetsAECGCGC = {
  
    optPatientMeetsAECGCGCA : [
     {
       categoryId:4,
        controlId:1,
        controlValueId:41,
...
//   }
  ...
  export const patientMeets2016ACRECCriteria = {
    chkPatientMeets2016ACRECCriteria :{
        categoryId:4,
        controlId:13
      },
  }
  ...
  export const patientHasPhysiciansDiagnosis = {
      ...
      txtSjogrensSymptomsSuggestiveStartMM:{
        categoryId:4,
        controlId:14
      },

      chkSjogrensSymptomsSuggestiveStartMMNA:{
        categoryId:4,
        controlId:15
      },

      txtSjogrensSymptomsSuggestiveStartYYYY:{
        categoryId:4,
        controlId:16
      },

      chkSjogrensSymptomsSuggestiveStartYYYYNA:{
        categoryId:4,
        controlId:17
      },
      ...
      txtSjogrensSymptomsSuggestedStartMM:{
        categoryId:4,
        controlId:18
      },

      chkSjogrensSymptomsSuggestedStartMMNA:{
        categoryId:4,
        controlId:19
      },

      txtSjogrensSymptomsSuggestedStartYYYY:{
        categoryId:4,
        controlId:20
      },

      chkSjogrensSymptomsSuggestedStartYYYYNA:{
        categoryId:4,
        controlId:21
      },
