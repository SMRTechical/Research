...
class VisitComplete extends React.Component{
    constructor(props) {
        super(props);   
        this.state = {
            token: null,
...
renderCompleteButton() {
    return (
        <div className="alert alert-danger text-center complete-visit"  onClick={() => this.openVisitCompleteModal()}>
             Click here to complete visit
    </div>
    )
    }
