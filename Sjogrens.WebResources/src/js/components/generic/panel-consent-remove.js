...
class PanelConsentRemove extends React.Component{
constructor(props) {
        super(props);
    ...
    return(
        <div className="panel panel-danger panel-consent"  onClick={() => this.handleOnClick()}>
            <div className="panel-heading text-center">
                ...
                <i className="fa fa-times-circle-o fa-2 mr-10" aria-hidden="true"></i>{this.props.title}</h3>
            </div>
...
export default PanelConsentRemove;
