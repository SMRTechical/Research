...
class RoutineBloodsForm extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
...
renderExistingHeaderPanel(){
    ...
    <div className="panel-heading">
        <div className="row">
            ...
            <h3 className="panel-title pull-left">Routine Bloods</h3>
                </div>             
            </div>
        </div>
...
renderNewHeaderPanel(){
    ...
    return (
        ...
        <div className="panel-heading">
                <h3 className="panel-title">Routine Bloods</h3>
...
renderForm(){
 ...
 export default RoutineBloodsForm;
