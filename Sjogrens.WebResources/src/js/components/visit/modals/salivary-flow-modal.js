...
class SalivaryFlowModal extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    let errors = {};
        ...
        if (isValid)
        {
            this.props.ocularSignsConfirmed( this.state.ocularSignsObjectiveConfirmAR, this.state.ocularSignsObjectiveConfirmAL,this.state.ocularSignsObjectiveConfirmARNA, this.state.ocularSignsObjectiveConfirmALNA)
        }
       }
...
<div className="funkyradio-default">
 ...
 export default SalivaryFlowModal;
