...
class UltrasoundResultsForm extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
...
renderExistingHeaderPanel(){
    ...
    <div className="panel-heading">
        <div className="row">
            ...
            <h3 className="panel-title pull-left">Ultrasound Results</h3>
                </div>             
            </div>
        </div>
...
prevCategoryName = {VISIT_CATEGORY_INVESTIGATIONSREQUESTED}
showNextNav = {true}
showPrevNav = {true}
...
renderNewHeaderPanel(){
    ...
    return (
        ...
        <div className="panel-heading">
                <h3 className="panel-title">Ultrasound Results</h3>
...
renderForm(){
 ...
 export default UltrasoundResultsForm;
